...
CREATE USER 'worlduser'@'localhost' IDENTIFIED BY 'worldpw';

GRANT USAGE ON * . * TO 'worlduser'@'localhost' IDENTIFIED BY 'worldpw' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

GRANT ALL PRIVILEGES ON `world` . * TO 'worlduser'@'localhost' WITH GRANT OPTION ;
